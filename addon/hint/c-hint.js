...
(function(mod) {
  ...
  CodeMirror.registerHelper("hint", "anyword", function(editor, options) {
    ...
    for (var i = cKeywords.length - 1; i >= 0; i--) {
      if (cKeywords[i] === curWord) continue;
          if ((!curWord || cKeywords[i].lastIndexOf(curWord, 0) == 0) && !Object.prototype.hasOwnProperty.call(seen, cKeywords[i])) {
            seen[cKeywords[i]] = true;
            list.push(cKeywords[i]);
      }
    }
